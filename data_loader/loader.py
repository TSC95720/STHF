    ...
    def get_train_loader(self):
        if self.config.dataset=='vcm':
            ...
            train_loader = data.DataLoader(
                VideoDataset_train(self.samples.train_ir, self.samples.train_rgb,
                                   seq_len=self.seq_lenth, sample='video_train',
                                   transform0=self.transform_train, transform1=self.transform_color1_vcm,
                                   transform2=self.transform_color2_vcm, transform3=self.transform_thermal_vcm,
